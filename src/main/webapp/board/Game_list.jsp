...
.Game_information_header>div:nth-of-type(1){
    width: 170px;
    height: 100%;
    font-size: large;
    font-weight: 500;
...
.Game_information_header>div:nth-of-type(2){
    width: 170px;
    height: 100%;
    font-size: large;
    font-weight: 500;
...
.Game_information_section>div a{
    color: black;
    text-decoration-line: none; /* a태그 밑줄 제거*/
}
...
<body>
	...
	<div class="wrapper">
		...
		<nav class="search">
			<div>
				<form action="<c:url value="./Game_BoardListAction.do"/>"
					method="post">
					<div class="d-flex">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td><a class="text-dark"
									...
									href="./Game_BoardViewAction.do?num=<%=notice.getNum()%>&Game_pageNum=<%=Game_pageNum%>"><%=notice.getSubject()%></a></td>
		...
		<aside class="Game_information">
			<div>
				<header class="Game_information_header">
					<div>인기 게시판</div>
					<div>정보 게시판</div>
				</header>
				<section class="Game_information_section">
					<div>
