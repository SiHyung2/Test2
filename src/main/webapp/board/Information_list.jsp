...
.Information_information>div{
    width: 350px;
    height: 300px;
    margin: 100px 0px 0px 90px;
}
.Information_information_header{
    display: flex;
    width: 100%;
    height: 10%;
    background-color: lightgray;
...
.Information_information_header>div:nth-of-type(1){
    width: 170px;
    height: 100%;
    font-size: large;
    font-weight: 500;
...
.Information_information_header>div:nth-of-type(2){
    width: 170px;
    height: 100%;
    font-size: large;
    font-weight: 500;
...
.Information_information_section{
    width: 100%;
    height: 90%;
    border-left: 3px solid lightgray;
    border-bottom: 3px solid lightgray;
...
.Information_information_section>div{
    width: (100%-20px);
    height: 49px;
    font-size: large;
    font-style: italic;
...
.Information_information_section>div a{
    color: black;
    text-decoration-line: none; /* a태그 밑줄 제거*/
}
...
<body>
	...
	<div class="wrapper">
		...
		<nav class="search">
			<div>
				<form action="<c:url value="./Information_BoardListAction.do"/>"
					method="post">
					<div class="d-flex">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td><a class="text-dark"
									...
									href="./Information_BoardViewAction.do?num=<%=notice.getNum()%>&Information_pageNum=<%=Information_pageNum%>"><%=notice.getSubject()%></a></td>
		...
		<aside class="Information_information">
			<div>
				<header class="Information_information_header">
					<div>인기 게시판</div>
					<div>정보 게시판</div>
				</header>
				<section class="Information_information_section">
					<div>
