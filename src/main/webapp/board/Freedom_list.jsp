...
.Freedom_information>div{
    width: 350px;
    height: 300px;
    margin: 100px 0px 0px 90px;
}
.Freedom_information_header{
    display: flex;
    width: 100%;
    height: 10%;
    background-color: lightgray;
...
.Freedom_information_header>div:nth-of-type(1){
    width: 170px;
    height: 100%;
    font-size: large;
    font-weight: 500;
...
.Freedom_information_header>div:nth-of-type(2){
    width: 170px;
    height: 100%;
    font-size: large;
    font-weight: 500;
...
.Freedom_information_section>div{
    width: (100%-20px);
    height: 49px;
    font-size: large;
    font-style: italic;
...
.Freedom_information_section>div a{
    color: black;
    text-decoration-line: none; /* a태그 밑줄 제거*/
}
...
<body>
	...
	<div class="wrapper">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td><a class="text-dark"
									...
									href="./Freedom_BoardViewAction.do?num=<%=notice.getNum()%>&Freedom_pageNum=<%=Freedom_pageNum%>"><%=notice.getSubject()%></a></td>
		...
		<aside class="Freedom_information">
			<div>
				<header class="Freedom_information_header">
					<div>인기 게시판</div>
					<div>정보 게시판</div>
				</header>
				<section class="Freedom_information_section">
					<div>
